document.addEventListener('DOMContentLoaded', () => {
  ...
  const projects = [
    ...
    },
    {
      title: 'GAME HUB',
      image: 'image 1.png',
      tech: ['Group Project', 'Team Project', 'Frontend', 'Backend'],
    ...
    },
    {
      ...
      image: 'image 2.png',
      tech: ['Group Project', 'Hackathon', 'Frontend', 'Backend'],
  ...
  const certifications = [
    { name: 'J.P. Morgan - Software Engineering Job Simulation',  org: 'Forage', image: 'certificate 1.png' },
    { name: 'Accenture UK - Introduction to Technology Apprenticeship Job Simulation', org: 'Forage', image: 'certificate 2.png' },
    { name: 'Goldman Sachs - Operations Job Simulation', org: 'Forage', image: 'certificate 3.png' },
    { name: 'Goldman Sachs - Risk Job Simulation',  org: 'Forage', image: 'certificate 4.png' },
    { name: 'Deloitte Australia - Technology Job Simulation',  org: 'Forage', image: 'certificate 5.png' },
    { name: 'Data Visualization',  org: 'freeCodeCamp', image: 'certificate 6.png' },
    { name: 'Front End Development Libraries', org: 'freeCodeCamp', image: 'certificate 7.png' },
    { name: 'JavaScript Algorithms and Data Structures (Beta)',  org: 'freeCodeCamp', image: 'certificate 8.png' },
    { name: 'Career Essentials in Generative AI by Microsoft and LinkedIn',  org: 'Microsoft', image: 'certificate 9.png' },
    { name: 'Responsive Web Design', org: 'freeCodeCamp', image: 'certificate 10.png' },
    { name: 'Machine Learning with Python', org: 'freeCodeCamp', image: 'certificate 11.png' },
    { name: 'Data Analysis with Python',  org: 'freeCodeCamp', image: 'certificate 12.png' }
  ];
  ...
  const roles = ['Web Developer', 'Backend Developer', 'Frontend Developer', 'UI/UX Designer'];
  let roleIndex = 0;
